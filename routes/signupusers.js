...
const signupuserController=require('../controller/signupuser.model')


// handle get request for products
router.get('/',signupuserController.getSignupusers)
//  (req, res) => {
//     res.status(200).json({
...
router.post('/',signupuserController.createSignupuser)
//  (req, res) => {
...
router.get('/:signupuserID' ,signupuserController.getSignupusersByID,)
//  (req, res) => {
...
router.put('/:signupuserID',signupuserController.updateSignupuser)
//  (req, res) => {
//     const id = req.params.usernameID
//     res.status(200).json({
...
router.delete('/:signupuserID',signupuserController.deleteSignupuser)
//  (req, res) => {
//     const id = req.params.usernameID
//     res.status(200).json({
//         msg: "This is PUT request for username",
